            ...
            <div className="w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 px-4">
                {actuals.map((item) => (
                    <Link
                        ...
                        className="w-full aspect-5/4 rounded-3xl sm:rounded-4xl bg-[#181a1f] border border-neutral-800 transition-transform hover:-translate-y-2 cursor-pointer duration-300 relative overflow-hidden group"
                    >
                        {item.coverImage && (
