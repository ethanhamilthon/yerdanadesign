...
export function AboutMe() {
    ...
    return (
        <div id="about" className="w-full flex flex-col gap-8 sm:gap-12 md:gap-16 mt-8 sm:mt-10 md:mt-12 items-center px-0 sm:px-6 md:px-0">
            <h2 className="text-xl sm:text-2xl md:text-3xl tracking-tighter leading-tight sm:leading-snug md:leading-7 text-center font-medium text-neutral-100">
                {t('about.title')}
            </h2>
            <div className="w-full flex flex-col md:flex-row items-stretch gap-4 px-4 sm:px-0">
                <div className="w-full md:w-1/2 h-64 relative shrink-0">
                    <p className="z-10 absolute left-4 sm:left-6 bottom-4 sm:bottom-6 text-neutral-100 leading-4 sm:leading-5 text-lg sm:text-lg tracking-tighter pr-4">
                    ...
                    <div className="absolute inset-0 bg-linear-to-t sm:bg-linear-to-tr from-black from-20% via-black/80 to-transparent rounded-2xl"></div>
                    <img src="/new1.jpg" alt="" className="w-full h-full object-cover rounded-2xl" />
                </div>
                <div className="w-full md:w-1/2 flex flex-col sm:flex-row gap-4 h-auto md:h-64 shrink-0">
                    <div className="w-full sm:w-1/2 h-64 relative shrink-0">
                        ...
                        <div className="absolute inset-0 bg-linear-to-t sm:bg-linear-to-tr from-black from-20% via-black/80 to-transparent rounded-2xl"></div>
                        <img src="/new2.jpg" alt="" className="w-full h-full object-cover rounded-2xl" />
                    </div>
                    <div className="w-full sm:w-1/2 h-64 relative shrink-0">
                        <p className="z-10 absolute left-4 sm:left-6 bottom-4 sm:bottom-6 text-neutral-100 leading-4 sm:leading-5 text-lg sm:text-lg tracking-tighter pr-4">
                        ...
                        <div className="absolute inset-0 bg-linear-to-t sm:bg-linear-to-tr from-black from-20% via-black/80 to-transparent rounded-2xl"></div>
                        <img src="/new3.jpg" alt="" className="w-full h-full object-cover rounded-2xl" />
                    </div>
                </div>
            </div>
        </div>
