...
export function Contact() {
    return (
        <div className="w-full flex flex-col gap-8 sm:gap-10 md:gap-12 mt-12 sm:mt-16 md:mt-20 items-center">
            ...
            <div className="w-full px-4 sm:px-8 md:px-24 flex flex-col md:flex-row gap-8 md:gap-12">
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-between gap-8 md:gap-0">
                    <div className="w-full flex flex-col gap-6 md:gap-2">
                        ...
                        <div className="flex flex-col items-start gap-3 md:gap-2">
                            ...
                            <div className="flex flex-wrap sm:flex-nowrap px-2 sm:px-4 justify-center items-center py-2 gap-2 sm:gap-0 rounded-3xl sm:rounded-full bg-neutral-100 border border-neutral-300 w-full sm:w-auto">
                                <button className="flex-1 sm:flex-none px-4 sm:px-6 cursor-pointer py-2 rounded-full bg-[#ff003c] text-white text-sm sm:text-base">
                                    Telegram
                                </button>
                                <button className="flex-1 sm:flex-none px-4 sm:px-6 cursor-pointer py-2 rounded-full bg-transparent sm:bg-neutral-100 text-neutral-500 text-sm sm:text-base">
                                    WhatsApp
                                </button>
                            </div>
                    ...
                    <button className="w-full px-6 cursor-pointer py-4 rounded-full bg-[#ff003c] text-white text-base sm:text-lg font-medium transition-transform active:scale-[0.98]">
                        Отправить
                    </button>
                </div>
            </div>
...
function Service() {
    return <div className="w-full rounded-4xl sm:rounded-full flex justify-between items-center text-neutral-500 bg-neutral-200 border border-neutral-400 px-4 sm:px-8 py-3 gap-2">
        <span className="text-sm sm:text-base leading-tight">Визуальная система</span>
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
            <svg className="cursor-pointer shrink-0 w-4 sm:w-5 h-4 sm:h-5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="cursor-pointer shrink-0 w-[14px] sm:w-[18px] h-[14px] sm:h-[18px]" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
